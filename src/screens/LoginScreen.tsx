...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onNavigateSignUp }) => {
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <View style={styles.cardWrapper}>
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.primaryButton} onPress={() => onLogin(email, password)}>
